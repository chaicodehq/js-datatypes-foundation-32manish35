...
export function createPaanOrder(basePaan, customizations) {
  ...
  let newOrder = Object.assign({},basePaan,customizations)
  return newOrder
}
/*- Object.freeze() se menu ko immutable banao
 *      - Return: frozen object
...
export function updatePrices(menu, increase) {
  ...
  return Object.fromEntries(
    Object.entries(menu).map(([key, price]) => [
      key,
      price + increase
    ])
  );
...
const safeSpecial = typeof specialsMenu === "object" && specialsMenu !== null? specialsMenu : {}
return {
  ...safeRegular,
  ...safeSpecial
}
